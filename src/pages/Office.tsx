...
import { ClipLoader } from "react-spinners";
import { AirVentIcon, CircuitBoardIcon, MapPin, ProjectorIcon, SpeakerIcon, VideoIcon, WifiIcon } from "lucide-react";
        ...
        {space ? (
           ...
           <div className="flex py-12">
             <div className="mx-6 flex flex-col gap-6 w-full">
                 ...
                 <h1 className="text-xl font-semibold bg-slate-100 p-2 w-fit rounded-md text-[#00593F]">₦{space?.price} / day</h1>
               ...
               <li key={index} className="amenity-item flex gap-2 bg-slate-100 w-fit p-4 rounded-md">
                 {amenityIcons[amenity] || <i className="icon-default" />} {/* Display icon */}
                 <span>{amenity.replace('_', ' ')}</span> {/* Display amenity name */}
               </li>
             ))}
                 </ul>
               </div>
