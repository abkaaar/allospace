...
const Footer = () => {
  return (
    <>
      ...
      <footer className="bg-[#000] pt-12 pb-8 px-4">
        <div className="mx-auto px-4 container overflow-hidden flex flex-col lg:flex-row justify-between">
          ...
          <div className="w-2/3 block sm:flex text-sm mt-6 lg:mt-0">
            ...
            <div className="text-gray-700 flex flex-col w-full">
              <div className="inline-block py-2 px-3 text-[#00593F] uppercase font-semibold tracking-wide">
                Follow Us
              </div>
              <div className="flex pl-4 justify-start mt-2">
                <a
                  className="flex items-center text-[#00593F] mr-6 no-underline"
                  href="#"
                >
                  <svg
                    viewBox="0 0 24 24"
                ...
                <a
                  className="flex items-center text-[text-[#00593F]] mr-6 no-underline"
                  href="#"
                >
                  <svg
                    viewBox="0 0 24 24"
                ...
                <a
                  className="flex items-center text-[#00593F] no-underline"
                  href="#"
                >
                  <svg
                    viewBox="0 0 24 24"
        ...
        <div className="mt-4 pt-6 text-gray-600 border-t border-gray-800 text-center">
          {" "}
          © 2024 Allospace. All rights reserved.
        </div>
      </footer>
    </>
  );
