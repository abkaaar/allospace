  ...
  const faqs: FAQ[] = [
    {
      ...
      answer: "It's easy! Simply create an account, provide your space details, and upload high-quality photos. You'll be live in minutes."
    },
    {
      question: "How does payment splitting work?", 
      answer: "Our integrated payment gateway ensures you receive your share of the booking fee, while also accommodating commissions for platform services."
    },
    {
      question: "Can I set different rates for peak hours or special events?",
      answer: "Yes, AlloSpaces allows you to customize pricing based on demand."
    }
  ];
